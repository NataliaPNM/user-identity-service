  ...
  @ApiResponses(
      value = {
        ...
        @ApiResponse(
            responseCode = "428",
            description =
                "Precondition required. Login and password are correct. "
                    + "Account confirmation required (one-time password change).",
            content =
                @Content(
                    mediaType = "application/json",
                    schema =
                        @Schema(implementation = AccountConfirmationRequiredErrorResponse.class))),
        @ApiResponse(
            responseCode = "423",
            description =
                "Account is temporary locked, with no attempts left "
  ...
  @ApiResponses(
      value = {
        ...
        @ApiResponse(
            responseCode = "400",
            description =
                "Invalid token. Refresh token can not be found in the database, "
  ...
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "406",
            description =
                "The new password will be saved after confirmation by the code. "
        ...
        @ApiResponse(
            responseCode = "423",
            description =
                "Error for the case when you try to access the endpoint with a password change, "

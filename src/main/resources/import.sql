...
INSERT INTO secure_data (id, login, password, refresh_token, user_id)VALUES (nextval('secure_generator'),'postgres','$2a$12$SaJgBAKTMINE/Nf1.bLhG.c1zjgCLJ.l3lHAH8GYQMq.kN3YEbaH.','',1);
INSERT INTO secure_data (id, login, password, refresh_token,user_id)VALUES (nextval('secure_generator'),'ttnpnm','$2a$12$yPCb2tQjR.TW6S7xyD69CuDvS7flvmyiyxqqHPOg1lmwBfOtRglJ6','',2);
